...
DIR_PATH=/Volumes/LDC/Xunlei/KN_APP_2.0.5/swjsq

SIGN="iPhone Developer: dicong liu (Q7GG5982GB)"
PROFILE="c2a381b7-3952-4970-868b-c6bf69242a5d"
SIGNTODAY="iPhone Developer: dicong liu (Q7GG5982GB)"
PROFILETODAY="9847d84b-d154-4630-b33d-9683fcf02be0"
...
xcodebuild -workspace $DIR_PATH/$TARGET_NAME.xcworkspace -scheme $TARGET_NAME \
-configuration $IPA_TYPE clean archive \
kuainiao_${IPA_TYPE}_profile=$PROFILE \
kuainiao_${IPA_TYPE}_sign="iPhone Developer: dicong liu (Q7GG5982GB)" \
kuainiaotoday_${IPA_TYPE}_profile=$PROFILETODAY \
kuainiaotoday_${IPA_TYPE}_sign="iPhone Developer: dicong liu (Q7GG5982GB)" \
-archivePath $TEMP_DIR/$TARGET_NAME.xcarchive
